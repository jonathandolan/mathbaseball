...
public class AddStudent extends JFrame implements ActionListener {
    ...
    private void editStudent(){
        ...
        if(! oldFirstName.equals(textField2.getText()))
            dBase.changeFirstName(oldUserName, textField2.getText());
        if(! oldLastName.equals(textField1.getText()))
            dBase.changeLastName(oldUserName, textField1.getText());
